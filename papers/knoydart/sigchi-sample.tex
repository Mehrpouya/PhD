...
\begin{abstract}
In this paper we will explain the design process and implementation of a series of interventions developed in Knoydart to develop new ways of looking at Knoydart renewable energy. The project started in September 2014 in collboration with Community Energy Scotland, Local Energy Scotland and Knoydart Foundation. As a method of initiating conversations with the community in Knoydart we developed a series of visualisation....
\end{abstract}

\keywords{
Design Intervention; Design; Anthropology; Renewable Energy
	}
